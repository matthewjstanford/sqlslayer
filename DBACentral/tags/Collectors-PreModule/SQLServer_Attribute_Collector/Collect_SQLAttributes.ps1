$LogFile = "E:\Production\DBACentral\SQLServer_Attribute_Collector\Logs\SQLServer_Attribute_Collector_Log_$(get-date -uformat ""%Y%m%d%H%M"").txt"

if ((Test-Path "E:\Production\DBACentral\SQLServer_Attribute_Collector\Logs") -ne 1)
{
	New-Item "E:\Production\DBACentral\SQLServer_Attribute_Collector\Logs" -type directory
}
